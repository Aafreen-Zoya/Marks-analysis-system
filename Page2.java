...
public class Page2 extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //new Page7().setVisible(true); // TODO add your handling code here:
        try{
            String i = t1.getText();
            String p = t2. getText();
            ...
            String q="select * from register where id ='"+i+"' and password ='"+p+"'";
           ...
           ResultSet rs =stmt.executeQuery(q);
            if(rs.next()){
                new Page7().setVisible(true);
                 ...
                 t3.setText("wrong password or wrong id ,please try again");
            }
